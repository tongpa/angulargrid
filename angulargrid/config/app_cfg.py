# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in angulargrid.
...
import angulargrid
from angulargrid import model, lib
...
base_config.package = angulargrid
...
base_config.model = angulargrid.model
base_config.DBSession = angulargrid.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "154b49b5-47b6-41da-baf1-64e0709961b7"
